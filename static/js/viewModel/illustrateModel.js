...
define('illustrate',[],function(){
    var data = {
          ...
          "newslist": [
              {
                "textImg": ko.observable("http://design.yonyoucloud.com/static/img/desiner3.jpg"),
                "title": ko.observable("奥运在即 中国体操女队入场训练"),
                "titleColor": "#258FB9",
                "textContext": ko.observable("8月4日,中国体操队队员范忆琳在赛前训练中。当日,中国体操女队队员在里约热内卢奥林匹克体育馆进行训练。里约奥运会体操比赛将于8月6日拉开战幕."),
                "buttonText" : "查看更多",
                "titleSize": "18px"
              },{
                "textImg": ko.observable("http://design.yonyoucloud.com/static/img/desiner6.jpg"),
                "title": ko.observable("福原爱领衔日本乒乓球队训练备战"),
                "titleColor": "#fff",
                "textContext": ko.observable("2016年8月5日，2016年里约奥运会，福原爱领衔日本乒乓球队备战。988年11月1日出生于日本宫城县仙台市，日本乒乓球运动员。2000年，成为历史上年龄最小的日本国家队成员。"),
                "buttonText" : "查看更多",
                "titleSize": "18px"
              },
              {
                "textImg": ko.observable("http://design.yonyoucloud.com/static/img/desiner4.jpg"),
    ...
    var illustrateModel = function(data) {
        ...
        this.addItem = function() {
            var newIllustrateItem = {
                "textImg": ko.observable("http://design.yonyoucloud.com/static/img/desiner5.jpg"),
